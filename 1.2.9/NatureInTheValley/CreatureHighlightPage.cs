...
namespace NatureInTheValley
{
	...
	{
		// Token: 0x060000C3 RID: 195 RVA: 0x000116D0 File Offset: 0x0000F8D0
		...
		// Token: 0x060000C4 RID: 196 RVA: 0x00011960 File Offset: 0x0000FB60
		public override void draw(SpriteBatch b)
		{
			...
			else
			{
				...
				{
					string text3 = text2;
					if (this.translation.Get(text2).HasValue())
					{
						text3 = this.translation.Get(text2);
					}
					if (text != "")
					{
						if (!text.Contains(text3))
						{
							...
							{
								text = text + this.translation.Get("and") + text3;
							}
						}
					}
					else
					{
						text = text + this.translation.Get("Found") + text3;
					}
					num++;
				}
			}
		...
		// Token: 0x060000C5 RID: 197 RVA: 0x000026D9 File Offset: 0x000008D9
		public static void ExitFunction()
		{
			Game1.activeClickableMenu = new ClickIntoCreatureInfoMenu();
		}

		// Token: 0x060000C6 RID: 198 RVA: 0x00012468 File Offset: 0x00010668
		...
		// Token: 0x060000C7 RID: 199 RVA: 0x0001253C File Offset: 0x0001073C
